// داده‌های اکوسیستم سرمایه‌گذاری خطرپذیر — هنوز از سوی تیم پل ارائه نشده است.
...
export const ventureCategories: EcosystemCategory[] = [];

export const ventureCompanies: Company[] = [];
